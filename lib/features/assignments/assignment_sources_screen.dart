...
class AssignmentSourcesScreen extends ConsumerWidget {
  const AssignmentSourcesScreen({super.key});
      ...
      body: Column(
        ...
        children: [
          ScreenHeader(
            ...
            subtitle: 'Configura cómo los catálogos se convierten en asignaciones.',
            actions: [
              GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Configura cómo los catálogos se convierten en asignaciones.',
                      style: AppFonts.geist(
